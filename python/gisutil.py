...
def GetTiffProj4String(filename):
...
def GetTiffProj4String2(filename):
...
def GetGridLatLon2(InputDemFileName,model_para_dir,projstring,latfilename,lonfilename):
      asciifilename=model_para_dir+"hydropara/ws.asc"
      if (len(projstring.strip())==0):      
            proj4string=GetTiffProj4String(InputDemFileName)
